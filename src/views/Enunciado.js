...
const preambulo = () => {
    return(
        <div className="margined lore">
            <div className="underlined"> 🦠 T0: DESOLACIÓN </div>
...
const conexion = () => {
    return(
        <div className="margined lore">
            <div className="underlined"> 👤 T1: COMUNICACIÓN </div>
            O al menos, no hasta ese día donde unos desarrolladores dentro de la colonia lograron contactar con un
            antiguo laboratorio central, donde una misteriosa entidad les respondió. <br></br>

            Este ente, quien presumía de haber sido el asistente de uno de los líderes culpables de la epidemia
